...
public class UserViewModel extends AndroidViewModel {
    ...
    public MutableLiveData<Task<AuthResult>> registerUser(String email, String password) {
        MutableLiveData<Task<AuthResult>> resultLiveData = new MutableLiveData<>();
        resultLiveData.setValue(userRepository.registerUser(email, password));
        return resultLiveData;
    }

    public MutableLiveData<Task<AuthResult>> loginUser(String email, String password) {
        MutableLiveData<Task<AuthResult>> resultLiveData = new MutableLiveData<>();
        resultLiveData.setValue(userRepository.loginUser(email, password));
        return resultLiveData;
    }
}
